...
\newcommand{\result}[1]{\color{\resultColor}#1\color{black}}
...
\NewDocumentCommand{\drawPoint}{mmm O{\pointColor} O{(0,0)}}{
    ...
    \draw[line width = \crossWidth, shift={#5}, color = #4] (#2 - 0.25,#3) -- (#2 + 0.25,#3);
    \draw[line width = \crossWidth, shift={#5}, color = #4] (#2,#3 - 0.25) -- (#2,#3 + 0.25);
}
