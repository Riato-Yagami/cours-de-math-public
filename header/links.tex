\newcommand{\defl}[2]{%
    \expandafter\def\csname #1\endcsname{\href{#2}{#1}}%
}

% Page Eduscol
\defl{collège}{https://eduscol.education.fr/280/mathematiques-cycle-4}
...
\defl{Terminal}{https://eduscol.education.fr/document/24568/download}
