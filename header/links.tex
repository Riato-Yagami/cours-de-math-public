...
\def\dmeepc{\href{https://publimath.univ-irem.fr/PCO10003}
    {Des maths ensemble et pour chacun}
}


\newcommand*{\wiki}[1]{\href{https://fr.wikipedia.org/wiki/#1}{Wikipédia (\reverseSnakeCase{#1})}}

\newcommand*{\prbltq}[1]{\href{https://www.problematheque-csen.fr/fiche-probleme/#1}{Problémathèque (\reverseKebabCase{#1})}}

\NewDocumentCommand{\rpmc}{O{}}{\href{https://eduscol.education.fr/document/13132/download?attachment\#page=#1}{La résolution de problèmes mathématiques au collège (p.\ncalc{#1+3})}}
\def\ca{%
...
\defIconLink{Geogebra}{Blue}{geogebra/logo}{https://www.geogebra.org/classic}
