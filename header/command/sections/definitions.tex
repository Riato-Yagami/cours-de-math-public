...
\newsec{sub}{cor}{Corollaire} % NavyBlue
\newsec{sub}{lem}{Lemme} % NavyBlue
\newsec{sub}{ctr}{Contraposée} % NavyBlue
\newsec{sub}{rmdr}{Rappel} % Thistle
...
\def\explColor{gray}
\newsec{subsub}{rmk}{Remarque} % Thistle
\newsec{subsub}{expl}{Exemple}
\newsec{subsub}{app}{Application} %RedViolet
\newsec{subsub}{exo}{Exercice}
\newsec{subsub}{corr}{Correction}
\newsec{subsub}{act}{Activité} % BurntOrange
