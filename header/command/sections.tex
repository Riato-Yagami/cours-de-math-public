...
\newsec{sec}{pr}{Red}{Propriété}
\newsec{sec}{df}{SeaGreen}{Définition}
\newsec{sec}{thm}{Maroon}{Théorème}
...
\newsec{sub}{rmdr}{Crimson}{Rappel} % Thistle
\newsec{sub}{mthd}{FireBrick}{Méthode}
\newsec{sub}{vc}{MediumSeaGreen}{Vocabulaire}
\newsec{sub}{nt}{ForestGreen}{Notation}
\newsec{sub}{hist}{Black}{Histoire}
\newsec{sub}{axio}{Mahogany}{Axiome}
\newsec{sub}{objSUB}{gradeColor}{Objectifs}

\def\explColor{gray}
\newsec{subsub}{rmk}{Crimson}{Remarque} % Thistle
\newsec{subsub}{expl}{\explColor}{Exemple}
...
\newsec{subsub}{cpd}{Orange}{Coup de pouce}
