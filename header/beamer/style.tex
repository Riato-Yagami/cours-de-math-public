...
\newcommand{\titleBox}[1]{
    \begin{beamercolorbox}[ht=2.13ex,dp=0.6ex,wd=\paperwidth,leftskip=.3cm,rightskip=.3cm]{frametitle}
...
{
    \vspace{-4pt} % Adjust the vertical space before the title
...
\setbeamertemplate{footline}
{
    ...
    \raisebox{2ex}{\large\textbf{\hypersetup{urlcolor=gradeColor} \link{\grade}}} % Adjusts position and adds your text in bold
...
\definecolor{hyperlinks}{HTML}{FFFFFF}
\hypersetup{
    colorlinks = true,
    linkcolor = gradeColor!01, % Apply the color to internal links
    urlcolor = hyperlinks!01   % Apply the color to URLs
}
