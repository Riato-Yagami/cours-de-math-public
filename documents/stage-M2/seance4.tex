...
% \maketitle
\slide{Exercices}{
    \img{/stage-M2/seance4/exo_13_figure_papier_quadrille.png}
}
...
\slide{}{
    ...
    \begin{minipage}{0.45\textwidth}
        \begin{tikzpicture}[x=\tikzScale, y=\tikzScale]
            ...
            \onslide<2->{
                \draw[line width= 0.8mm, Green, shift= \figShift] (0,0) -- (0,2) -- (1,2) -- (1,1) -- (3,1) -- (3,0) -- cycle;
...
\slide{}{
    \img{/stage-M2/seance4/exo_5_p183_myriade_4e_2016.png}[9cm]
}

\slide{}{
    \img{/stage-M2/seance4/exo_translation_triangle_quadrillage.png}[9cm]
}
...
\slide{Cours}{
    ...
    \vspace*{-1cm}
    \img{stage-M2/seance4/translation_point.png}[6cm]
}


\slide{}{
    \img{stage-M2/seance4/translation_point.png}[9cm]
}

\slide{}{
    \begin{minipage}{0.35\textwidth}
        \img{stage-M2/seance4/translation_point.png}
    \end{minipage}
...
\slide{}{
    ...
    \img{stage-M2/seance4/translation_triangle.png}[6cm]
}