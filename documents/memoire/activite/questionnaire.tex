% VARIABLES %%%
\def\theme{\Large Questionnaire - Activité : Triangles rectangles et hauteurs}
\def\date{04/11/2023}
%%%%%%%%%%%%%%%
...
\questions{
    ...
    ,%
    Trouves-tu les maths intéressantes de manière général?
...
\questions{
    Cette activité t'a-t-elle intéressé ? Qu'est-ce qui t'a plu ou déplu ?
    ,%
