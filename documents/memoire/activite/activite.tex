...
\hint{
    \begin{itemize}
        ...
        \item Répondre au questions sur le document réponse en page 2.
        \item Toute recherche au brouillon est encouragé et est à écrire sur le document réponse (recto ou au verso).
    \end{itemize}
}\vspace*{0.2cm}
