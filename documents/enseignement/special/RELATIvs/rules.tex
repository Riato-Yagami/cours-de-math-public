...
\slide{Règles du jeu duel (2 joueurs)}{
    ...
    \begin{enumerate}
        \item \textbf{Piocher une opération :} Le joueur ayant la \hand pioche une carte opération et la dépose face découverte à côté de la pile.
...
\slide{Propriétés du jeu}{\vspace{-0.6cm}%\setboolean{showID}{false}
    ...
    \pr{Division}{On divise la première \daz par le seconde et :
        ...
        \vspace{-0.5cm}\expl{}{\vspace{-0.5cm}
            \multiColItemize{2}{
                \item $\seven\obelus\two = 3,5$ ou $\dfrac{7}{2}$
                \item $\mnine\obelus\four = -2,25$ ou $- \dfrac{9}{4}$
            }
        }
    }
