...
\slide{cr}{
    \expl{}{
        \multiColEnumerate{2}{
            ...
            \item $\nswr{27} =$ \baseDecomposition{27}{12}
            \item $\nswr{112} =$ \baseDecomposition{112}{12} \saveenumi
        }\multiColEnumerate{1}{\loadenumi
            \item $145 =$ \nswr{\baseDecomposition{145}{12}}
        }
    }
}
...
\qfSlide{
    \multiColEnumerate{2}{
        \item \nswr{6425} = \baseDecomposition{6425}{10}
        \item \nswr{1237} = \baseDecomposition{1237}{12}
...
\slide{exo}{
    \begin{enumerate} \loadenumi[act]
        \item \multiColEnumerate{2}{
            \item \Babylone{86} = \nswr{86}
            \item \aspc \nswr{\Babylone{132}} = 132
            \item \Babylone{325} = \nswr{325}
            \item \Babylone{7271} = \nswr{7271}
            \item \aspc \nswr{\Babylone{10872}} = 10872
        } \saveenumi
    \end{enumerate}
}
...
\slide{cr}{
    \expl{}{
        \multiColEnumerate{2}{
            \item \nswr{186} = \baseDecomposition{186}{60}
            \item \nswr{1200} = \baseDecomposition{1200}{60}
            \item 720 = \baseDecomposition{75}{60}["hide"]
            \item 1842 = \baseDecomposition{500}{60}["hide"] \saveenumi
        }\multiColEnumerate{1}{\loadenumi
            \item 8350 = \nswr{\baseDecomposition{8350}{60}}
        }
    }
}
...
\nswr[0]{
    \begin{enumerate}
        \item La division euclidienne de $384$ par $12$ donne :
        $384 = 12 \times 32 + 0$.
        Il y a donc $32$ douzaines de crêpes emballées, et il reste $0$ crêpes à manger pour les employés.
        \item 
        \multiColItemize{3}{
            \item mardi : $1004 = 12 \times 83 + 8$
            \item mercredi : $519 = 12 \times 43 + 3$
            \item jeudi : $1069 = 12 \times 89 + 1$
            \item vendredi : $1102 = 12 \times 91 + 10$
        }
        En additionnant les restes : $0 + 8 + 3 + 1 + 10 = 22$. Les employés ont mangé en tout $22$ crêpes.
        Le nombre d'employés est donc un diviseur de $22$, soit : $1$, $2$, $11$ ou $22$.
    \end{enumerate}
}\avspace{0.5cm}
...
\slide{qf}{
    \multiColEnumerate{1}{
        \item $7 + 5 - 4 \times 2 = \nswr{7 + 5 - 8 = 12 - 8 = 4}$
        \item $7 + (5 - 4) \times 2 = \nswr{7 + 1 \times 2 = 7 + 2 = 9}$
        \item $(7 + 5 - 4) \times 2 = \nswr{(13 - 4) \times 2 = 9 \times 2 = 18}$
    }
}
...
\slide{cr}{\bshrink
    ...
    \expl{Nommer les calculs suivants}{
        ...
        \multiColEnumerate{1}{
            \item $1,6 + 4$ est \nswr{la somme} de \nswr{$1,6$ et $4$}.
            \item $(\frac{2}{6} + 3) \times 9$ est \nswr{le produit } de \nswr{$\frac{2}{6} + 3$ et $9$}.
            \item $6,6 + 1 \times 8$ est \nswr{la somme de $6,6$ par $1 \times 8$}.
            \item $\frac{2}{6} + 3 - 9$ est \nswr{la différence entre $\frac{2}{6}$ et $9$}.
...
\slide{qf}{\bvspace{-0.5cm}
    \exo{}{
        \multiColEnumerate{1}{
            \item $10 \times 3 + 4 \div 2 = \nswr{30 + 2 = 32}$
            \item $5 \times 4 \div 2 = \nswr{20 \div 2 = 10}$
            \item $4 \times (1 + 16 - 10) = \nswr{4 \times (17 - 10) = 4 \times 7 = 28}$
            \item $100 \div (10 \times (2+3)) = \nswr{100 \div (10 \times 5) = 100 \div 50 = 2}$
        }
    }
}
