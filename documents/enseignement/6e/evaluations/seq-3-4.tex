...
\exo{Calculs en lignes}{
    ...
    \begin{enumerate}
        \item $211 \times 2 + 12 \times 4 = \awsr[3]{422 + 48 = 470}$ 
        \item $2 \times \np{10 000} + (14 - 9) = \awsr[3]{\np{20 000} + 5 = \np{20 005}}$
        \item $(24 + 2 \times 6) \div 2 = \awsr[3]{(24 + 12) \div 2 = 36 \div 2 = 18}$
    \end{enumerate}
}
...
\answerFill[Réponse][
    \begin{itemize}
        ...
        \item $125 \times 8 = 1250$ Il peut faire 1250 baguettes avec sa farine.
        \item $1250 \times 2 = 2500$ \Prix{2500} Il vendra pour \Prix{2500} de baguettes.
        \item $2500 - 250 = 2250$ \Prix{2250} Il fera un bénéfice total de \Prix{2250}.
    \end{itemize}
]
...
\exo{\bonus Numération Maya}{
    ...
    \begin{enumerate}
        ...
        \awsr[4]{Le symbole \Maya{1} correspond à une unité, tandis que \Maya{5} représente cinq unités.}
        %
        ...
        \awsr[5]{Un espace horizontal entre deux symboles indique un changement de classe : on passe du comptage des unités à celui des vingtaines.}
        %
        \item Quelle est la base utilisée dans cette numération ?\\
        \awsr[3]{Cette numération est en base 20.}
        %
        \item Que signifie le symbole \Maya{0} ?\\
        \awsr[4]{Le symbole \Maya{0} indique qu'il n'y a aucune unité dans la classe où il est placé.}
        %
        \item Complète les égalités suivantes :
        \multiColEnumerate{3}{
            \item \Maya{33} = \awsr{33}
            \item \Maya{453} = \awsr{453}
            \item \aspc\awsr{\Maya{156}} = 156
        }
    \end{enumerate}
}
