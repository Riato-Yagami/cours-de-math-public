...
\slide{exo}{
    ...
    \exo{}{En s'apuyant sur la figure ci-dessous, compléter les phrases suivantes :
        \begin{enumerate}
            \item Le point $A$ est situé à \awsr{$2$ }$\Lg{}$ de la droite $(d)$.
            \item La distance du point $B$ à la droite \awsr{$(d)$} vaut $\Lg{2}$.
            \item Le point $B$ est à la distance $BF$ de la droite \awsr{$(d')$}.
            \item La distance du point $A$ à la droite $(d'')$ est \awsr{$AE$}.
            \item Le point $D$ est situé à \awsr{$0$} $\Lg{}$ de la droite $(d')$.
            \item Parmi les points $A$,$B$, $C$ et $D$, le point le plus proche de $(d'')$ est \awsr{$A$}. 
        \end{enumerate}
...
\slide{cr}{
    ...
    \df{}{
        ...
        \begin{itemize}
            \item \awsr{\key{rayon}}, un segment joignant le centre à un point du cercle.
            \item \awsr{\key{corde}}, un segment dont les extrémités se trouvent sur le cercle.
            \item \awsr{\key{diamètre}}, une corde passant par le centre.
            \item \awsr{\key{arc}}, une portion de cercle délimitée par deux points.
        \end{itemize}
