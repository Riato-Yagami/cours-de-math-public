...
\ifthenelse{\boolean{answer}}{\pbreak}{}

\nswr[0]{
    \input{resources/enseignement/4e/calcul-litteral/dm-escargot.tex}
    \begin{enumerate}
        \loadenumi[][2]%
        \item \begin{itemize}
            \item On a $SAB$, un triangle rectangle en $A$.
        ...
        \end{itemize}
        \loadenumi[][6]%
        \item L'hypoténuse du \trgl[4] est de longueure $\sqrt{5}\,\Lg{}$.
        \item L'hypoténuse de \trgl[6] sera de longueure $\sqrt{6}\,\Lg{}$,
        et celui du \trgl[35] sera de longueure $\sqrt{36}\,\Lg{}$.
...
\ifthenelse{\boolean{answer}}{\pbreak}{\foot}