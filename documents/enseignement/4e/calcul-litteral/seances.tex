...
\slide{exo}{
    \input{resources/enseignement/4e/calcul-litteral/exo-ranger-des-pommes.tex}
}

\slide{exo}{
    \input{resources/enseignement/4e/calcul-litteral/exo-zzzzz.tex}
}

\scn{Simplifier une expression}

\slide{qf}{
    \input{resources/enseignement/4e/calcul-litteral/exo-indentifier-une-somme-ou-un-produit.tex}
}
...
\slide{qf}{
    \input{resources/enseignement/4e/calcul-litteral/exo-simplifier-des-sommes.tex}
}

\slide{exo}{
    \input{resources/enseignement/4e/calcul-litteral/act-demonstration-de-la-simple-distributivite.tex}
}
...
\slide{cr}{
    \sseq
    \input{resources/enseignement/4e/calcul-litteral/pr-distributivite-simple.tex}
    \input{resources/enseignement/4e/calcul-litteral/vc-distributivite.tex}
    \input{resources/enseignement/4e/calcul-litteral/expl-developper-une-expression.tex}
    \input{resources/enseignement/4e/calcul-litteral/expl-factoriser-une-expression.tex}
}
...
\slide{exo}{
    \setboolean{answer}{true}
    \input{resources/enseignement/4e/calcul-litteral/exo-mission-indigo.tex}
}
...
% \input{resources/enseignement/4e/calcul-litteral/dessine-moi-une-expression-algebrique.tex}