...
\cor{Egalité des quotients}{
    On a aussi : $\dfrac{a}{b} = \dfrac{c}{d}$
}

\demo{}{
    On a : $\dfrac{a}{b} = \dfrac{ a\times d}{b \times d} = \dfrac{ \nswr{b \times c} }{b \times d}$ d'après l'égalité des produits en croix.\\
    Or $\dfrac{ b \times c }{b \times d} = \nswr{\dfrac{c}{d}}$.
    Alors $\dfrac{a}{b} = \nswr{\dfrac{c}{d}}.$
...
\expl{}{
    ...
    \nswr[5]{
        \begin{enumerate}
            \item $\dfrac{10}{12} = \dfrac{20}{24} \neq \dfrac{20}{23}$
            alors on n'a pas égalité des quotients,
            il ne sagit donc pas d'un tableau de proportionnalité.
            \item $\dfrac{2}{3} = \dfrac{4}{6} = \dfrac{6}{9}$
