...
\begin{enumerate}
    ...
    \item Créer une perpendiculaire à la droite (AB). Puis placer C sur cette perpendiculaire. Enfin, créer le segment $[CB]$.\\
    \hint{Nouvel outil à utiliser : \tool{Perpendiculaire}[perpendicular]}
