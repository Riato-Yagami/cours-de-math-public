...
\slide{cr}{
    ...
    \pr{}{
        ...
        \begin{itemize}
            \item de \key{même signes} est \awsr{\key{positif}}.
            \item de \key{signe opposés} est \awsr{\key{négatifs}}.
        \end{itemize}
    }
}
...
\slide{cr}{
    \expl{}{
        \multiColEnumerate{2}{
            \item $-3 \times (-8) = \awsr{24}$
            \item $-8 \div (-6) = \awsr{\frac{-8}{-6} = \frac{8}{6} = \frac{4}{3} \approx \np{1.3333}}$
            \item $-3 \times 5 = \awsr{-15}$
            \item $5 \times (-4) = \awsr{-20}$
            \item $-4 \div 2 = \awsr{\frac{-4}{2} = -\frac{4}{2} = -\frac{2}{1} = -2}$
            \item $4 \div (-5) = \awsr{-\frac{4}{5} = -0.8}$
        }
    }
...
\slide{qf}{
    \multiColEnumerate{1}{
        ...
        \item $1 + (-6) - (-2) = \awsr{13}$
        \item $(-30) + \np{50.9} = \awsr{20.9}$
        \item $1 + (-6) \times (-2) = \awsr{13}$
        \item $3 \div (-1) = \awsr{-3}$
        \item $-7 \times (1 - (-2)) = \awsr{-21}$
    }
}
...
\slide{cr}{
    \expl{}{
        \begin{enumerate}
            \item \sialors{$a^2 = 16$}{$a = \awsr{4}$ ou $a = \awsr{-4}$}
            \item \sialors{$b^2 = 1$}{$b = \awsr{1}$ ou $b = \awsr{-1}$}
            \item \sialors{$c^2 = 21$}{$c = \awsr{\sqrt{21}}$ ou $c = \awsr{-\sqrt{21}}$}
            \item Soit $x$ un nombre positif, \sialors{$d^2 = x$}{$d = \awsr{\sqrt{x}}$ ou $d = \awsr{-\sqrt{x}}$}
        \end{enumerate}
    }
}
