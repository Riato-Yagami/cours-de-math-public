...
\answerFill[Réponse][\begin{enumerate}
    ...
    \item \begin{itemize}
        ...
        et des longueurs de ces deux autres côtés.
        \item Et ils ont comme longueur respectivement
        deux fois la longueur l'hypothénus du triangle $ABC$
        et deux fois des longueurs de ces deux autres côtés.
        \item Alors leurs aires sont respectivement les doubles des aires des carrés construit sur l'hypothénus et sur ces deux autres côtés.
        \item Hors d'après le théorème de Pythagore l'aire du carré construit sur l'hypothénus est égale à la somme des aires des carrés construit sur les deux autres côtés.
