...
%         $\dfrac{22\times\np{1.5}}{11} = \dfrac{33}{11} = 3$
%         % \item $\dfrac{30\times(-6)}{-18} = \dfrac{-180}{-18} = 10$
...
\exo{Manipulation de relatifs}{
    \multiColEnumerate{1}{
        ...
        % \item $\dfrac{2-[5-3\times(2-4)]}{2-15\div5} = \nswr[3]{
        %     \dfrac{2-[5-3\times(-2)]}{2-3}
        %     = \dfrac{2-[5-6]}{-1}
        %     = \dfrac{2-[-1]}{-1}
        %     = \dfrac{3}{-1}
        %     = -3
...
\exo{\ttps Reconnaître un tableau de proportionnalité}{
