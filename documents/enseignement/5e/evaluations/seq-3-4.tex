...
\exo{}{
    \multiColEnumerate{1}{
        ...
        = \bawsr{9\times 5 - 1 = 45 -1 = 44}$
        \item $\frac{45,5}{2\times3-1}
        = \bawsr{\frac{45,5}{6-1} = \frac{45,5}{5} = 9,1}$
        \item $\frac{27}{2\times3}-1
        = \bawsr{\frac{27}{6} -1 = 4,5 - 1}$
        \item $\frac{17-5}{3}+2
        = \bawsr{\frac{12}{3}+2 = 4 + 2 = 6}$
        \item $7\times\frac{15\times4}{3-2}+2\times8
        = \bawsr{7 \times \frac{60}{6}+ 16 = 7 \times 10 + 16 = 70 + 16 = 86}$
    }
}[\sesa{5}{2024}[10][41]]
