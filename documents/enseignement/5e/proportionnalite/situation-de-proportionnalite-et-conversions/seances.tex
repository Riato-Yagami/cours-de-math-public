...
\qfSlide{
    Donner le résultat sous la forme décimale de :
    \multiColEnumerate{2}{
        \item $14 \times 3 = \palt{2}{\ncalc{14*3}} $
        \item $3 \div 2 = \palt{2}{1,5} $
        \item $6 \div 4 = \palt{2}{1,5} $
        \item $5,6 \times 2 = \palt{2}{11,2} $
        \item $\dfrac{1}{4} = \palt{2}{0.25}$
        \item $\dfrac{3}{4} = \palt{2}{0.75}$
    }
}
...
\slide{exo}{
    ...
    \act{}{
        \begin{itemize}
            ...
            Peut-il prévoir de combien de gousses d'ail il aura besoin ?\\
...
\slide{cr}{
    \expl{}{
        ...
        Combien en coûtent $13kg$ de lentilles ?
    }
...
\slide{exo}{
    \act{Complète avec les unités manquantes}{\avspace{-0.5cm}
        \multiColEnumerate{2}{
...
\slide{exo}{
    \act{}{
        Un pilote de kart parcours 90 km en trois-quarts d'heure.
        En imaginant qu'il soit capable de maintenir cette vitesse,
        combien de kilomètres aura-t-il parcouru en 1 heure ?
    }
}
...
\slide{cr}{
    ...
    \expl{}{
        \begin{enumerate}
            \item Combien y'a-t-il de secondes dans une journée ?
            \item Convertir $78\min$ en heures.
            \item Convertir $7292\sec$ au format heures, minutes, secondes.
        \end{enumerate}
    }
}
