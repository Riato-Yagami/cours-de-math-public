...
\slide{}{
    ...
    \df{}{
        ...
        \begin{itemize}
            \item si $k>0$, alors $A$ et $A'$ sont du même côté par rapport $O$ et $OA'$ = $k \times OA$
            \item si $k<0$, alors $A$ et $A'$ ne sont pas du même côté par rapport à $O$ et $OA'$ = $-k \times OA$
        \end{itemize}
    }
}
...
\slide{}{
    ...
    \mthd{Construction homothétie}{
        ...
        \begin{enumerate}
            ...
            du même côté que $A$ par rapport à $O$ si $k>0$,
            sinon du côté opposé.
        \end{enumerate}
    }
}
