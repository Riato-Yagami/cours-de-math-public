...
\slide{}{
    ...
    \expl{}{
        ...
        \begin{enumerate}
            ...
            \iquestion{(\dfrac{2}{3})^3}{\pow{\dfrac{2}{3}}{3} 
            = \dfrac{4}{9} \times \dfrac{2}{3} 
            = \dfrac{8}{27}}
...
\slide{}{
    \expl{}{
        \startQuestions
        \begin{enumerate}
            \iquestion{3^{-2}}{\dfrac{1}{3^2} = \dfrac{1}{9}}
            \iquestion{5^{-1}}{\dfrac{1}{5^1} = \dfrac{1}{5}}
            \iquestion{\dfrac{1}{4^{3}}}{4^{-3}}
            \iquestion{\dfrac{1}{x^{3}}}{x^{-3}}
        \end{enumerate}
    }
}
...
\slide{}{
    \expl{}{
        ...
        \begin{enumerate}
            ...
            \iquestion{\dfrac{(-5)^6}{(-5)^3}}{(-5)^{6-3} = (-5)^{3}}
        \end{enumerate}
    }
}
...
\slide{}{
    ...
    \pr{}{
        ...
        \begin{itemize}
            ...
            \iquestion{\si b\neq 0, (\dfrac{a}{b})^n}{\dfrac{a^n}{b^n}}
        \end{itemize}
    }
}
...
\slide{}{
    \expl{}{
        ...
        \begin{enumerate}
            ...
            \iquestion{(\dfrac{2}{3})^5}{\dfrac{2^5}{3^5}}
            \iquestion{4^3 \times 7^3}{(4 \times 7)^3 = 28 ^3}
            \iquestion{\dfrac{36^7}{3^7}}{(\dfrac{36}{3})^7 = 12^7}
        \end{enumerate}
    }
}
