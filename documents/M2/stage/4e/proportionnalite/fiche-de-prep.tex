...
\demo{Egalité des produits en croix}{
    ...
    \begin{align*}
        &\propTable{a}{c}{b}{d}\\
        \iona \dfrac{a}{b} &= \dfrac{a \times d}{b \times d}\\
        \iet \dfrac{c}{d} &= \dfrac{c \times b}{d \times b}\\
        \ior \dfrac{a}{b} &= \dfrac{c}{d} \textrm{ (égalité des quotients)}
        \ialors \dfrac{a \times d}{b \times d} &= \dfrac{c \times b}{d \times b}
