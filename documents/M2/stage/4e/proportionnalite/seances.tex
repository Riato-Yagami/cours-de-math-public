...
\slide{}{
    \mthd{Calcul 4e proportionnelle}{
        ...
        \begin{align*}
            a \times d &= b \times c\\
            \ialors \palt{2}{\dfrac{a \times d}{d}} &= \palt{2}{\dfrac{b \times c}{d}}
            \ialors a &= \palt{3}{\dfrac{b \times c}{d}}
        \end{align*}
    }
}
...
\slide{}{
    \expl{}{ 
        ...
        \begin{center}
            ...
            \vspace{0.2cm}
            \propTable{x}{6}{\palt{2}{\dfrac{3.6x}{6}}}{3,6}
            \propTable{\palt{2}{\dfrac{1}{12}}}{\dfrac{1}{6}}{3}{6}
        \end{center}
    }
...
\slide{Cours}{
    ...
    \expl{}{ 
        Calculer $30\%$ de $60$.\\
        On fait : \palt{2}{$60 \times \dfrac{30}{100} = 10$}
    }
    \vspace{-0.7cm}
}
...
\slide{}{
    ...
    \begin{center}
        \begin{tabular}{|C{\cW}|C{\cW}|C{\cW}|C{\cW}|C{\cW}|C{\cW}|C{\cW}|}
            \hline
            \colA $\dfrac{a}{3}$ & \colA & \colA & \colB $\dfrac{b}{4}$ & \colB & \colB & \colB\\
            \hline
        \end{tabular}\\
...
\slide{}{
    ...
    Dans notre exemple;
    Assan a reçu $\palt{2}{\dfrac{3}{7}}$ des bonbons,
    et Esteban $\palt{2}{\dfrac{4}{7}}$
}
...
\slide{Exercices}{
    \exo{}{
        ...
        \palt{2}{
            \begin{align*}
                4+7+8 &= 19\\
                494\euro \times \dfrac{4}{19} &= 104\euro\\
                494\euro \times \dfrac{7}{19} &= 182\euro\\
                494\euro \times \dfrac{8}{19} &= 208\euro
            \end{align*}
        }
    }
}
...
\slide{}{
    ...
    \rmdr{Conversion}{
        ...
        \begin{align*}
            ...
            \alors 30\min &= \palt{5}{\dfrac{30}{60}\hour = 0,5\hour}\\
...
\slide{}{
    ...
    \begin{center}
        \begin{tabular}{|C{2.5cm}|C{\cW}|C{\cW}|}
            \hline
...
\slide{}{
    \expl{}{
        ...
        \begin{align*}
            v = \dfrac{d}{t} = \palt{2}{\dfrac{1}{120}} = \palt{3}{120\km / \hour}
        \end{align*}
    }
    \pr{}{
