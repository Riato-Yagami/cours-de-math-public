...
\qf{
    ...
    {$\dfrac{10^5}{10^2} \et \dfrac{10^5}{10^{-2}}$, $\dfrac{10^5}{10^2} < \dfrac{10^5}{10^{-2}}$},
    {$\dfrac{1}{(10^2)^3} \et 10^{-5}$, $\dfrac{1}{(10^2)^3} < {10^-5}$}%
}[10]
