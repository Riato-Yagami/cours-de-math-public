...
\thm{Des restes chinois (2 équations)}{
    Soient $m,n\in\m{N}$, tels que $\pgcd{m}{n}=1$.\\
    Alors,
    pour tout $(a,b)\in\m{Z}^2$,
    le système:
    \begin{equation*}
        \lfbrace{x \equiv a [m] \\ y \equiv b [n]}
    \end{equation*}
    admet au moins une solution.\\
    De plus, si $x_0$ est une solution particulière,
