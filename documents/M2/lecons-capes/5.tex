...
\df{Fréquence}{
    ...
    \begin{align*}
        \textrm{fréquence} &= \dfrac{\textrm{effectif}}{\textrm{effectif total}}\\
        f_{x_i} &= \dfrac{n_i}{N}, \forall i \in [|1;n|]
    \end{align*}
}
...
\df{Moyenne}{
    ...
    \begin{align*}
        \textrm{moyenne} &= \dfrac{\textrm{somme des valeurs}}{\textrm{effectif total}}\\
        \moy{x} &= \sN \sumN x_i\\
...
\demo{}{
    ...
    \begin{align*}
        ...
        &= \sN \sumN x_i^2 - \dfrac{2\moy{x}}{N} \sumN x_i  + \sN N \moy{x}^2\\
        &= \sN \sumN x_i^2 - \dfrac{2\moy{x}}{N} N \moy{x} + \moy{x}^2\\
...
\df{Coefficient de corrélation linéaire}{
    ...
    \begin{align*}
        r(x,y) = \dfrac{Cov(x, y)}{\sigma(x)\sigma(y)}
    \end{align*}
}
...
\demo{Méthode Lycée}{
    ...
    \begin{align*}
        ...
        \iet P(a) \textrm{ minimal en } a =& -\dfrac{\beta}{2\alpha} \textrm{ (polynôme du second degré)}\\
        =& \dfrac{2Cov(x,y)}{2V(x)} = \dfrac{Cov(x,y)}{V(x)}
    \end{align*}
}[\href{https://www.bibmath.net/resources/index.php?action=affiche&quoi=capes/demos/statistiques.html}{Bibmath}]

\newcommand{\partJ}[1]{
    \dfrac{\partial J}{\partial #1}
}
...
\demo{Méthode experte}{
    ...
    \begin{align*}
        ...
        \ialors &\lfbrace{
            (\dfrac{1}{N} \sumN x_i y_i -  \moy{x}\moy{y}) - a (\dfrac{1}{N} \sumN x_i^2 - \moy{x}) = 0\\
            b = \moy{y} - a \moy{x}
        }
        \ialors &\lfbrace{
