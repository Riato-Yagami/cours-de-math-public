...
\tice{Algorithme d'Euclide}{Python}{
    \lstinputlisting[language=Python]{resources/lecons-capes/5/euclide.py}
}
...
\demo{}{
    ...
    \end{align*}
    d'où $a|c$
}[\href{https://www.bibmath.net/resources/index.php?action=affiche&quoi=capes/demos/arithmetique.html}{Bibmath}]
...
\rmk{Forme irréductible de $r$}{
    ...
    s'écrit de manière unique $r=\dfrac{p}{q}$ avec $p\in\m{Z}$, $q\in\m{N*}$ et $\pgcd{p}{q} = 1$.
}
