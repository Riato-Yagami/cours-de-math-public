...
\begin{enumerate}[label=\textbf{\color{red}\arabic*. \color{black}situation \arabic*}, wide, labelwidth=!, labelindent=0pt]
    ...
    \aEnum{
        ...
        On a pour $x\in[0;10]$:
        \begin{align*}
            f(x) &= x \times \dfrac{(l - 3x)}{2} \times (L-2x)\\
            &= x \times \dfrac{45-3x}{2} \times (30 - 2x)
            ...
            \iet f(x_2) &= 1500
        \end{align*}
        On trouve donc une boite de dimension $\dfrac{(l - 3x_2)}{2} \times (L-2x_2) \times x$,
        c'est a dire:\\
