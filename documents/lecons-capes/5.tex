...
\rmk{Médiane Ecart interquartile}{
...
\demo{Méthode Lycée ($G$ dans $(d)$ admis)}{
    ...
    \begin{align*}
        ...
        &= \sumN (\dmoy{y} - a \dmoy{x})^2\\
        &= \sumN \dmoy{y}^2 + a^2 \dmoy{x}^2 - 2a\dmoy{y}\dmoy{x}\\
        &= \sumN \dmoy{y}^2 + a^2 \sumN \dmoy{x}^2 - 2a \sumN \dmoy{y}\dmoy{x}\\
