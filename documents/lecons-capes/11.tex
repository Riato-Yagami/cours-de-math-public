...
\def\co{\textrm{coté opposé}}
\def\ca{\textrm{coté adjacent}}
...
\df{Sinus}{\vspace*{-0.25cm}
    \begin{align*}
        \sin(\widehat{b}) = \frac{\co}{\hy} = \frac{AC}{BC}
    \end{align*}
}

\df{Cosinus}{\vspace*{-0.25cm}
    \begin{align*}
        \cos(\widehat{b}) = \frac{\ca}{\hy} = \frac{AB}{BC}
    \end{align*}
}

\df{Tangente}{\vspace*{-0.25cm}
    \begin{align*}
        \tan(\widehat{b}) = \frac{\co}{\ca} = \frac{AC}{AB}
    \end{align*}
}
...
\demo{}{
    ...
    on a:
    \begin{align*}
        \cos{x} &= \frac{AB}{BC} \et \sin{x} = \frac{AC}{BC}
        \ialors \cos^2{x} + \sin^2{x} &= \left(\frac{AB}{BC}\right)^2 + \left(\frac{AC}{BC}\right)^2\\
        &= \frac{AB^2+AC^2}{BC^2}\\
...
\demo{}{\vspace*{-1cm}
    \begin{align*}
        \frac{\sin{x}}{\cos{x}} &= \frac{\frac{AB}{BC}}{\frac{AC}{BC}}\\
        &= \frac{AB}{BC} \times \frac{BC}{AC}\\
        &= \frac{AC}{AB} = \tan{x}
    \end{align*}
}
...
\cor{}{
    ...
    on a:
    \begin{align*}
        \pscalv{AB}{AC} = \frac{1}{2} (AB^2 + AC^2 - BC^2)
    \end{align*}
}
...
\thm{d'Al-Kashi}{
    \dividePage{
        Soit un triangle de coté $a,b,c$ et d'angle $\gamma$ opposé à $c$,
        on a:
        \begin{equation*}
